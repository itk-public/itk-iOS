...
- (void)addBackBarButton
{
    ...
    backBtton.frame     = CGRectMake(0, 0, 80, 40);
    [backBtton setImage:[UIImage imageNamed:@"icon_back"] forState:UIControlStateNormal];
    backBtton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    backBtton.titleLabel.font = KFontNormal(16);
    [backBtton setTitle:@" 返回" forState:UIControlStateNormal];
    [backBtton setTitleColor:kColorTheme forState:UIControlStateNormal];
    [backBtton addTarget:self

...
-(ShopcartTableViewProxy *)shopcartTableViewProxy
{
    if (_shopcartTableViewProxy == nil) {
        ...
        _shopcartTableViewProxy.mainCellName = NSStringFromClass([ShopCartCell class]);
        _shopcartTableViewProxy.cartSellerHeaderViewName = NSStringFromClass([CartSellerHeaderView class]);

...
-(instancetype)init{
    if (self = [super init]) {
        ...
        [_lineView setBackgroundColor:UIColorFromRGB(0xf1f6f9)];
        [self addSubview:_lineView];
        
        _textFiled = [[UITextField alloc]init];
        [_textFiled setFont:KFontNormal(15)];
        ...
        _rightBtn.titleLabel.font = KFontNormal(15);
...
-(void)layoutSubviews{
    ...
    CGFloat kBtnW  = 105;
    if (self.inputModel.type == TextFiledTypeSetPwd) {
        kBtnW = 50;
    }
...
-(void)rightBtnOnClicked:(UIButton *)rightBtn
{
    if (self.inputModel.type == TextFiledTypeSetPwd) {
        ...
        self.textFiled.secureTextEntry = self.rightBtn.selected;
    }
}
